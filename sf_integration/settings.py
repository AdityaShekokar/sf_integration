"""
Django settings for sf_integration project.
...
SECRET_KEY = '^5sec=jxl3y*^#c0hh%l8-j0a__ju#2m1nt&46=ggjkpa=wz7i'
...
ROOT_URLCONF = 'sf_integration.urls'
...
WSGI_APPLICATION = 'sf_integration.wsgi.application'
